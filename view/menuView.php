		...
		<div class="container">
			<div id="bl-main" class="bl-main">
				...
				<section class="propos">
					<div class="bl-box">
						<a class="link" href="../index.php?action=about"><h2>A propos</h2></a>
            <img src="../img/ete.jpg">
					</div>
				</section>
				<!-- projet -->
				...
				<!-- <section class="projet"> -->
					<div class="bl-box">
						<a class="link" href="../index.php?action=projects"><h2>Projets</h2></a>
            <img src="../img/printemp.jpg">
				...
				<section class="article">
					<div class="bl-box">
						<a class="link" href="../index.php?action=articles"><h2>Articles</h2></a>
            <img src="../img/automne.jpg">
				...
				<section class="contact">
					<div class="bl-box">
						...
						.php?action=contact"><h2>Contact</h2></a>
