...
<div class="container-fluid apropos">
  <div class="jumbotron p-0">
    <input style="display:none" onClick="window.close()"/><a href="view/menuView.php"><img class="float-sm-right p-1" src="bootstrap-icons/x-circle-fill.svg" alt="close" width="32" height="32" title="Bootstrap"></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-sm-12 p-2">
            <div class="column h-100 align-items-center">
              <h4 class="d-flex h-20"><?php echo htmlspecialchars($row['titre']) ?></h4>
              <p class="d-flex h-70"><?php echo htmlspecialchars($row['texte']) ?></p>
    ...
    <div class="column h-50 p-4">
      ...
      <div class="row h-80">
        ...
        <div class="col-md-4">
          ...
          <p>Rédaction d'un cahier des charges</p>
          <p>Cadrage</p>
