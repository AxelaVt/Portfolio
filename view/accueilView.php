    ...
    <div class="container-fluid p-0">
      ...
      <div class="d-flex flex-column w-100 h-100 justify-content-center flex-wrap align-content-center ">
        ...
        <div class="col-lg-2 col-sm-4 w-100 d-flex flex-column justify-content-end align-items-center">
          <!-- href="./index.php?action=menu" -->
          <a href="view/menuView.php"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
